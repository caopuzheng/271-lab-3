...
> As a start, fitting a linear model helps identify significant explanatory variables and evaluate how strong the linear relationship is.
...
> The estimated coefficient on *per se laws* is negative (which aligns with our EDA observation) but not significantly different from zero. Its interpretation is that changing the per se laws from no (0) to yes (1) will cause traffic fatalities rate to decrease by 2.17%, however, this effect is not statistically significant.
...
> The estimated coefficient on *primary seatbelt laws* (seatbelt1) is negative, which aligns with our EDA observation, but is not significantly different from zero. Its interpretation is that changing the seatbelt law from no requirement to primary requirement will cause traffic fatalities rate to decrease marginally (0.067%), not statistically or practically significant. 
