...
> In this model version, blood_alcohol_limit  of 0.1 is the default value for the base model. The estimated coefficient on *blood alcohol limit 0.08* is -0.045924 and significantly different from zero at 5%. The interpretation of this coefficent is that changing the legal blood alcohol limit from 0.10% to 0.08% caused traffic fatalities rate to decrease by 0.04539 per 100,000 people. 


- Do *per se laws* have a negative effect on the fatality rate? 

> The estimated coefficient on *per se laws* is negative (which aligns with our EDA observation) but not significantly different from zero. Its interpretation is that the presence of the per se laws causes traffic fatalities rate to decrease by 0.013310 per 100,000 people. 

- Does having a primary seat belt law?
> The estimated coefficient on *primary seatbelt laws* (seatbelt1) is negative, which aligns with our EDA observation, but is not significantly different from zero. Its interpretation is that the presence of a primary seatbelt laws causes traffic fatalities rate to decrease by -0.00067 per 100,000 people. 
