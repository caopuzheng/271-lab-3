...
```{r data-processing, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r data-diagnose-and-cleanup categorical fields, echo=FALSE, include=FALSE}
...
```{r minimum-drinking-age, echo=FALSE, include=FALSE}
...
```{r distribution-plots1, warning=FALSE, message=FALSE}
df %>%
  select(
    total_fatalities_rate,
    nighttime_fatalities_rate,
...
```{r pairplot-on-feature-of-interest-continuous, fig.height=5, fig.width=6, echo=FALSE}
df %>%
  mutate(
...
```{r monthly-miles-driven-covid-change, warning=FALSE, message=FALSE}
vehicle_miles_month %>%
