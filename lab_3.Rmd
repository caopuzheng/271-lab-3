...
```{r avg-fatality-by-year, warning=FALSE, fig.align='center', out.width="55%", echo=FALSE}
df_avg <- df %>%
...
```{r distribution-plots1, warning=FALSE, message=FALSE, fig.align='center', out.width="55%", echo=FALSE}
df %>%
  select(
    total_fatalities_rate,
    nighttime_fatalities_rate,
...
```{r cross-sectional-plot, fig.align='center', out.width="55%", echo=FALSE}
...
```{r pairplot-on-feature-of-interest-continuous, fig.align='center', out.width="75%", echo=FALSE}
...
```{r pairplot-on-feature-of-interest-discrete, fig.align='center', out.width="75%", warning=FALSE, echo=FALSE}
df %>%
  select(
    total_fatalities_rate,
    seatbelt,
...
```{r compute-pearson-correlation-confusion-matrix, fig.align='center', out.width="85%", echo=FALSE}
df %>%
...
#TODO: put all models into appendix
...
#TODO: add this to the stargazer
...
> In this model version, blood_alcohol_limit  of 0.1 is the default value for the base model. The estimated coefficient on *blood alcohol limit 0.08* is -4.6% and significantly different from zero at 5%. The interpretation of this coefficent is that changing the legal blood alcohol limit from 0.10% to 0.08% will cause the traffic fatalities rate to be 4.4% lower. 
...
```{r monthly-miles-driven-covid, fig.align='center', out.width="50%", echo=FALSE}
...
```{r pairplot-on-feature-of-interest-continuous2, ref.label='pairplot-on-feature-of-interest-continuous', echo=TRUE}
```
