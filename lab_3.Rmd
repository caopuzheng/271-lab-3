...
# we do have 48 states -> missing states 2, 9, and 12. Thus, the ordering is a little bit off
df %>% 
...
> Holding everything else constant, if the number of miles driven per capita decreased by 39.1%, the number of traffic fatalities would increase by $-39.1% * \beta = -29.5%$. We should be cautious here since the change in independent variable is very large, so the log interpretation might not be accurate.
