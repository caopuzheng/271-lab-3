...
df <- data %>% 
  ...
  mutate(speed_limit_70plus = factor(sl70plus),
...
# TODO:  Should we make all values (39) not equal to 0 or 1 to 1 and make it a factor variable
df %>%
  filter(zero_tolerance_law!=0 & zero_tolerance_law!=1)
# TODO:  Should we make all values (20 )  not equal to 0 or 1 to 1 and make it a factor variable
table(df$graduated_drivers_license_law)

df %>%
  filter(graduated_drivers_license_law!=0 & graduated_drivers_license_law!=1)

# TODO:  Should we make all values (27) not equal to 0 or 1 to 1 and make it a factor variable
...
```
 ...
 - Blood alcohol: Most states have the limit of 0.1.
...
re.model <- plm(log(total_fatalities_rate) ~ factor(year)
              + factor(blood_alcohol_limit)
              + per_se_laws
              + seatbelt
              + speed_limit_70plus
