...
```{r}
df <- plm.data(df, indexes = c('year','state'))
...
> If there is serial correlation or heteroskedasticity in the idiosyncratic errors of the model, the standard errors of the estimators will be biased and underestimated. In our cases, both the fixed effects and random effects models showed a normally distributed residuals, leading us to conclude that there are no serial correlation or heteroskedasticity.
